    ...
    <div className="p-5 border border-orange-300 rounded-xl bg-white shadow-lg h-full">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col justify-between">
        ...
        <div className="pt-4">
          <button
            type="submit"
            className="w-full py-2 px-4 rounded-lg font-bold bg-sky-600 text-white shadow-md cursor-pointer hover:bg-sky-700 transition duration-150 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500 mt-2"
          >
            Actualizar Tarea
          </button>
        </div>
